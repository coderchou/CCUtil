...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"%@",[CCSandBoxUtil bundlePath]);
    NSLog(@"%@",[CCSandBoxUtil homePath]);
    NSLog(@"%@",[CCSandBoxUtil documentPath]);
    NSLog(@"%@",[CCSandBoxUtil libraryPath]);
    NSLog(@"%@",[CCSandBoxUtil preferencePath]);
